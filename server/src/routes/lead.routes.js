...
router.post("/", protect, validate(createLeadSchema), createNewLead);
router.put("/:id", protect, validate(createLeadSchema), updateSingleLead);
router.delete("/:id", protect, authorize(["admin"]), removeLead);
